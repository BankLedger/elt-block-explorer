  ...
  this.node.getAddressSummary(address, options, function(err, summary) {
	...
	if(!summary){
      ...
      var transformed = {
          ...
          unspendValue: parseFloat((parseFloat(summary.balance.toFixed(8)) - parseFloat(summary.lockedValue.toFixed(8))).toFixed(8)),
          totalSentSat: parseFloat(summary.totalSpent.toFixed(8)),
